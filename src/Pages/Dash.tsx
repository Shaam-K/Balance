...
const Dash = () => {
  ...
  return (
    <section className="w-10/12 mx-auto">
      <div className="flex justify-between mt-[5vh] mx-4">
        <h1 className="text-2xl">My Issues</h1>
        <Link to={`create/`} className="border-b-2 hover:border-zinc-100 transition-all">
          Create Issue
        </Link>
      </div>
      <div className="mt-4">
              ...
              <li key={post.id} className="border p-4 rounded">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="flex gap-3">
                    <Link to={`/edit/${post.areaCode}/${post.id}`} className="border-b-2 hover:bg-green-500 px-3 hover:border-zinc-100 transition-all hover:translate-y-[-3px]"><div className="translate-y-[2px]">Edit</div></Link>
                    <Link to="" className="border-b-2 hover:bg-red-500 px-3 hover:border-zinc-100 transition-all hover:translate-y-[-3px]"><div className="translate-y-[2px]">Delete</div></Link>
                  </span>
                </div>
                <div className="flex">
